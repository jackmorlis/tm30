...
function SignInFormInner() {
  ...
  return (
    <div>
      ...
      {registered && (
        <div className="mb-5 p-3 rounded-lg bg-green-50 border border-green-200 text-[13px] text-success font-medium">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          <div className="flex items-center justify-between mb-1.5">
            <label className="text-[13px] text-gray-text">Password</label>
            <a
              href="#"
